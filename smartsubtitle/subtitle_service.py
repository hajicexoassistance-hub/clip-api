...
import sys
import os
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'smartcrop')))
from style_presets import get_style, get_available_styles
from animation_presets import get_animation, get_available_animations
...
def generate_ass(word_timings, options=None):
    ...
    if not word_timings:
        ...
        for line in lines:
            ...
            anim = get_animation(animation_preset, resolution=resolution)
